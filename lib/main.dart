...
import 'package:socialtest/login/login_widget.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Stream<SocialtestFirebaseUser> userStream;
  SocialtestFirebaseUser initialUser;
  ...
  void initState() {
    super.initState();
    userStream = socialtestFirebaseUserStream()
